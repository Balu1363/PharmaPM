                    ...
                    <div class="form-row">
                     ...
                     <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                         ...
                         <div class="form-group col-md-1">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" SetFocusOnError="true" Text="*" InitialValue="--Select--" ForeColor="Red" ControlToValidate="ddlProject" ErrorMessage="*" ValidationGroup="a"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
