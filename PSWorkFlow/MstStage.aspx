<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MstStage.aspx.vb" Inherits="PSWorkFlow.MstStage" %>
                ...
                <div class="form-group col-md-12">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-5 alert-info">
                            <asp:Label ID="Label1" runat="server" Font-Bold="true" ForeColor="#007bff" Text="Stage"></asp:Label>
                        </div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                         ...
                         <div class="form-group col-md-1">
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" SetFocusOnError="true" Text="*" InitialValue="--Select--" ForeColor="Red" ControlToValidate="ddlProject" ErrorMessage="*" ValidationGroup="a"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-2">
                            <asp:TextBox ID="txtStage" runat="server" MaxLength="100" CssClass="form-control" ValidationGroup="a"></asp:TextBox>
                        </div>
                        <div class="form-group col-md-1">
                            <asp:RequiredFieldValidator ID="reqProjects" runat="server" SetFocusOnError="true" Text="*" ForeColor="Red" ControlToValidate="txtStage" ErrorMessage="*" ValidationGroup="a"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-5">
                            <asp:Panel ID="PnlGrid" runat="server" ScrollBars="Auto">
                                <asp:GridView ID="gvStage" runat="server" AutoGenerateColumns="false" Width="100%" HeaderStyle-BackColor="#d1ecf1"
                                    CssClass="table table-sm table-striped table-bordered table-hover" HeaderStyle-ForeColor="#007bff" OnRowCommand="gvStage_RowCommand" OnRowUpdating="gvStage_RowUpdating"
                                    OnRowDeleting="gvStage_RowDeleting" OnRowEditing="gvStage_RowEditing">
                                    <Columns>
                                        ...
                                        <asp:TemplateField ItemStyle-Width="15px">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="btndelete" runat="server" CommandName="Delete" CausesValidation="false" OnClientClick="return confirm('Are you sure you want to delete this Stage?')"><img src="../Images/delete.png" height="15px" width="15px"/></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
